...
public class ProdutoController {
    ...
    public ProdutoDTO salvar(@RequestBody @Valid ProdutoDTO dto) {
        ...
        return new ProdutoDTO(produto.getId(), produto.getNome(), produto.getTamanho());
    }
    ...
    public List<ProdutoDTO> listar() {
        return produtoService.listar()
                .stream()
                .map(p -> new ProdutoDTO(p.getId(), p.getNome(), p.getTamanho()))
                .toList();
    }
    ...
    public ProdutoDTO atualizar(@PathVariable Long id, @RequestBody ProdutoDTO dto) {
        ...
        return new ProdutoDTO(atualizado.getId(), atualizado.getNome(), atualizado.getTamanho());
    }
